        ...
        if (params.functParam) {
            ...
            if (Array.isArray(functParam)) {
                for (var f = 0; f < functParam.length; f++) {
                    ...
                    var FieldData = {};
                    FieldData['Value'] = viewmodel.Fields()[tempIndex].Value();
                    FieldData['Options'] = viewmodel.Fields()[tempIndex].Options();
                    dataToSent[viewmodel.Fields()[tempIndex].Name()] = FieldData;
                }
            } else {
