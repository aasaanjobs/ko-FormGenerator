  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        ...
        meridianTemplate = '<input type="text" disabled style="background: #337ab7; padding: 1px; border-radius: 4px; border: 0px; color: #FFF; font-weight: 600;" class="bootstrap-timepicker-meridian" maxlength="2" data-action="toggleMeridian" />';
      } else {
